...
ActiveRecord::Schema.define(version: 20150329103741) do
  ...
  add_index "copies", ["book_id"], name: "fk_rails_6d66d5af8b", using: :btree
  add_index "copies", ["shop_id"], name: "fk_rails_d2d0067538", using: :btree
